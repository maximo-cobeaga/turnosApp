...
const freeURL = axios.create({
  baseURL: "https://89f425aa09f4.ngrok.app/api/v1/getFree/",
});
...
const makeBookURL = axios.create({
  baseURL: "https://89f425aa09f4.ngrok.app/api/v1/makeBook",
});
...
const getBooksURL = axios.create({
  baseURL: "https://89f425aa09f4.ngrok.app/api/v1/getBooks/",
});
